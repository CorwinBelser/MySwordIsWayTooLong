...
namespace Codexus
{
	...
	public class PixelColorFalloffWithDepthEffect : MonoBehaviour
    {
        [Header("Pixels size")]
        [Range(1.0f, 20f)]
		...
		public Texture falloffGradient;


        void SetMaterial()
        {
			pixelMaterial = new Material(Shader.Find("Custom/PixelColorFalloffWithDepth"));
        }
        ...
        void OnRenderImage(RenderTexture source, RenderTexture destination)
        {
			...
			pixelMaterial.SetTexture ("_FalloffGradient", falloffGradient);
