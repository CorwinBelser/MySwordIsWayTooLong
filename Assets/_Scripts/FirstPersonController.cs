...
namespace UnityStandardAssets.Characters.FirstPerson
{
    ...
    public class FirstPersonController : MonoBehaviour
    {
		...
		public SwordCollisions swordCollisions;
        ...
        private void FixedUpdate()
        {
			...
			if (obstacleDist >= 0f) {
				Debug.Log ("shit");
				Vector3 newDir = m_MoveDir.normalized * (obstacleDist / Time.fixedDeltaTime) * -3f;
				m_MoveDir.x = newDir.x;
				m_MoveDir.z = newDir.y;
			}
...
//			body.AddForceAtPosition (c.contacts [0].point, normal, ForceMode.Impulse);
//		}
    }
}
